# SEAL4Pyfhel
This is a fork of the original [SEAL](https://github/) project, a homomorphic encryption library in C++ from Microsoft. This repo contains a modified version, adapted to work with [Pyfhel](https://github.com/ibarrond/Pyfhel).
